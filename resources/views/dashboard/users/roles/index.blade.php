...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">@lang('users.list_roles')</h3>     
        ...
        <div class="box-body">
            <table id="roles-table" class="table table-bordered table-hover text-center">
                <thead>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                @permission('roles-read')
                                    <a class="btn btn-info btn-xs" href="{{ route('roles.show', $role->id) }}"><i class="fa fa-eye"></i> @lang('global.show') </a>
                                @endpermission
                                @permission('roles-update')
                                    <a class="btn btn-warning btn-xs" href="{{ route('roles.edit', $role->id) }}"><i class="fa fa-edit"></i> @lang('global.edit') </a>
                                @endpermission
                                @permission('roles-delete')
                                    <a href="{{ route('roles.show', $role->id) }}?delete=true" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> @lang('global.delete') </a>
                                @endpermission
                            </td>
                        </tr>
                    @endforeach
