...
<body>
    {{-- <htmlpageheader name="page-header"> --}}
        <div class="header">
          ...
          <h2>@lang('global.students_report')</h2>
          <div class="row">
            <div class="col-md-3">
              <p>@lang('courses.count') : {{ count($course->students) }}</p>
            </div>
            <div class="col-md-3">
              <p>@lang('courses.teacher') : {{ $course->teacher->name }}</p>
            </div>
            <div class="col-md-3">
              <p>@lang('global.course') : {{ $course->name }}</p>
            </div>
          </div>
       </div>
    {{-- </htmlpageheader> --}}
